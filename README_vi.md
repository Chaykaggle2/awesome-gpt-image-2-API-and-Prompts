# Awesome GPT Image 2 API và Gợi ý
...
Chào mừng đến với kho lưu trữ awesome-gpt-image-2-API-and-Prompts! 🤗

**Các mẫu API và gợi ý GPT Image 2 cho tạo hình ảnh, khám phá gợi ý, các trường hợp tham khảo và quy trình làm việc hình ảnh có thể tái sử dụng.**

Hầu hết các trường hợp trong kho lưu trữ này được tuyển chọn từ X/Twitter, cộng đồng sáng tạo, bản demo công khai và các thử nghiệm được chia sẻ.

Thử ngay trên Evolink: [GPT-Image-2](https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)

Nếu bạn thấy hữu ích, hãy cho một ngôi sao nhé. ⭐

> [!NOTE]
> Kho lưu trữ này tập trung vào các mẫu gợi ý có thể tái sử dụng, các trường hợp tham khảo và ví dụ theo từng tác vụ cho GPT-Image-2 trên Evolink.
> Các cập nhật chỉ gợi ý gần đây cũng được theo dõi trong `gpt_image_2_prompt.json`.
...
- **Ngày 5 tháng 5 năm 2026:** Đã thêm 12 trường hợp gợi ý GPT-Image-2 mới từ đợt tuyển chọn được phê duyệt hôm nay (4 chân dung, 5 áp phích, 3 giao diện) sau khi xem xét và xác thực phương tiện
- **Ngày 3 tháng 5 năm 2026:** Đã thêm 10 trường hợp gợi ý GPT-Image-2 mới từ đợt phê duyệt hàng ngày (1 thương mại điện tử, 1 sáng tạo quảng cáo, 3 chân dung, 2 áp phích, 3 giao diện) sau khi xem xét và xác thực phương tiện
- **Ngày 2 tháng 5 năm 2026:** Đã thêm 18 trường hợp gợi ý GPT-Image-2 mới từ đợt tìm kiếm 48 giờ qua (3 chân dung, 7 áp phích, 4 giao diện, 4 so sánh) sau khi xem xét và xác thực phương tiện
- **Ngày 30 tháng 4 năm 2026:** Đã thêm 9 trường hợp gợi ý GPT-Image-2 mới từ đợt tìm kiếm 24 giờ qua (3 chân dung, 1 áp phích, 3 giao diện, 2 so sánh) sau khi phê duyệt và xác thực phương tiện
- **Ngày 29 tháng 4 năm 2026:** Đã thêm 22 trường hợp gợi ý GPT-Image-2 mới qua các đợt xem xét (3 thương mại điện tử, 3 sáng tạo quảng cáo, 4 chân dung, 2 thiết kế nhân vật, 9 áp phích, 1 so sánh), đồng bộ hóa các mục gợi ý đã bản địa hóa cho Trường hợp 102 và 103, và đưa vào bộ kiểm tra hợp lệ rộng hơn
- **Ngày 26 tháng 4 năm 2026:** Đã thêm 9 trường hợp gợi ý GPT-Image-2 mới (1 thiết kế nhân vật, 7 áp phích, 1 giao diện)
- **Ngày 25 tháng 4 năm 2026:** Đã thêm 81 trường hợp gợi ý GPT-Image-2 mới (2 thiết kế nhân vật, 20 chân dung, 42 áp phích, 17 giao diện)
- **Ngày 24 tháng 4 năm 2026:** Đã thêm 19 trường hợp gợi ý GPT-Image-2 mới (6 so sánh, 6 áp phích, 7 giao diện)
- **Ngày 23 tháng 4 năm 2026:** Đã thêm 5 trường hợp gợi ý GPT-Image-2 mới (5 giao diện)
- **Ngày 23 tháng 4 năm 2026:** Chuẩn hóa tiêu đề trường hợp trong `README.md` và tất cả các tệp README đã bản địa hóa, bao gồm các mục menu, neo và tiêu đề trường hợp
- **Ngày 21 tháng 4 năm 2026:** Đã phân loại 48 trường hợp gợi ý mới vào các phần thư viện và tải xuống hình ảnh đầu ra được liên kết
- **Ngày 21 tháng 4 năm 2026:** Đã thêm 12 gợi ý GPT-Image-2 mới trên các trường hợp chân dung, áp phích, giao diện và so sánh
- **Ngày 20 tháng 4 năm 2026:** Đã thêm 10 gợi ý GPT-Image-2 mới được tuyển chọn cùng với tài nguyên hình ảnh cục bộ và cập nhật README.
- **Ngày 20 tháng 4 năm 2026:** Đã thêm 2 trường hợp gợi ý GPT-Image-2 mới (1 thiết kế nhân vật, 1 áp phích)
- **Ngày 19 tháng 4 năm 2026:** Đã thêm 10 gợi ý GPT-Image-2 mới trên các trường hợp áp phích, giao diện và so sánh
- **Ngày 19 tháng 4 năm 2026:** Đã thêm 5 trường hợp gợi ý GPT-Image-2 mới (3 áp phích, 2 giao diện)
- **Ngày 18 tháng 4 năm 2026:** Lần phát hành kho lưu trữ đầu tiên với bộ trường hợp GPT-Image-2 được tuyển chọn
...
- [📰 Tin tức](#-tin-tức)
- [Mục lục](#mục-lục)
- [🔌 Sử dụng API GPT Image 2](#-sử-dụng-api-gpt-image-2)
- [🛒 Trường hợp Thương mại Điện tử](cases/ecommerce_vi.md)
- [📣 Trường hợp Sáng tạo Quảng cáo](cases/ad-creative_vi.md)
- [🍌 Trường hợp Chân dung & Nhiếp ảnh](cases/portrait_vi.md)
- [🎨 Trường hợp Áp phích & Minh họa](cases/poster_vi.md)
- [🧍 Trường hợp Thiết kế Nhân vật](cases/character_vi.md)
- [📱 Trường hợp Giao diện & Mô phỏng Mạng xã hội](cases/ui_vi.md)
- [🧪 So sánh & Ví dụ Cộng đồng](cases/comparison_vi.md)
- [🙏 Lời cảm ơn](#lời-cảm-ơn)


## 🔌 Sử dụng API GPT Image 2

Bạn muốn nhanh chóng chuyển từ ý tưởng gợi ý sang tạo hình ảnh thực tế? Hãy sử dụng tài liệu API GPT Image 2 cùng với kỹ năng có thể gọi.

### 1. Cài đặt nhanh kỹ năng

- [Truy cập kho lưu trữ gpt-image-2-gen-skill](https://github.com/EvoLinkAI/gpt-image-2-gen-skill)
...
- [Lấy khóa API của bạn](https://evolink.ai/dashboard?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)
- [Đọc tài liệu API GPT Image 2](https://docs.evolink.ai/en/api-manual/image-series/gpt-image-2/gpt-image-2-image-generation?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)

## �� Trường hợp Thương mại Điện tử

> Xem tất cả các trường hợp → [cases/ecommerce_vi.md](cases/ecommerce_vi.md)

<!-- Case 151: E-commerce Main Image - Miniature Diorama Skincare Advertisement (by @Strength04_X) -->
### Case 151: [E-commerce Main Image - Miniature Diorama Skincare Advertisement](https://x.com/Strength04_X/status/2048074514278563949) (bởi [@Strength04_X](https://x.com/Strength04_X))
...
### Case 160: [E-commerce Main Image - 9-Panel Product TVC Storyboard](https://x.com/Magncsans/status/2047876253898903594) (bởi [@Magncsans](https://x.com/Magncsans))
...
### Case 163: [Burger hero image plus 9-cell ad storyboard](https://x.com/Gdgtify/status/2049449869530775877) (bởi [@Gdgtify](https://x.com/Gdgtify))
...
### Case 164: [Annotated Food Table Posts](https://x.com/iamsofiaijaz/status/2050627668861944073) (bởi [@iamsofiaijaz](https://x.com/iamsofiaijaz))
...
## 📣 Trường hợp Sáng tạo Quảng cáo

> Xem tất cả các trường hợp → [cases/ad-creative_vi.md](cases/ad-creative_vi.md)

<!-- Case 144: Luxury Chronograph Watch Ad (by @AlwaveNazca) -->
### Case 144: [Luxury Chronograph Watch Ad](https://x.com/AlwaveNazca/status/2048147643809865950) (bởi [@AlwaveNazca](https://x.com/AlwaveNazca))
...
### Case 150: [Luxury Miniature Dubai City Model](https://x.com/silentempiredev/status/2048086378383384773) (bởi [@silentempiredev](https://x.com/silentempiredev))
...
### Case 169: [Luxury chocolate campaign system](https://x.com/SPEEDAI07/status/2049459155086500321) (bởi [@SPEEDAI07](https://x.com/SPEEDAI07))
...
### Case 170: [Surreal Brand World Poster](https://x.com/SaasJunctionHQ/status/2050644926023844149) (bởi [@SaasJunctionHQ](https://x.com/SaasJunctionHQ))
...
## 🍌 Trường hợp Chân dung & Nhiếp ảnh

> Xem tất cả các trường hợp → [cases/portrait_vi.md](cases/portrait_vi.md)

<!-- Case 1: Convenience Store Neon Portrait (by @BubbleBrain) -->
### Case 1: [Convenience Store Neon Portrait](https://x.com/BubbleBrain/status/2045167461147042202) (bởi [@BubbleBrain](https://x.com/BubbleBrain))
...
### Case 84: [Ink-Etched Family Portrait](https://x.com/gdb/status/2048184698195870102) (bởi [@gdb](https://x.com/gdb))
...
### Case 99: [Dreamy Underwater Woman With Translucent Fish](https://x.com/kotobukigraphic/status/2047967522453123255) (bởi [@kotobukigraphic](https://x.com/kotobukigraphic))
...
### Case 100: [Monochrome Glitch Profile Portrait](https://x.com/Goodmanprotocol/status/2049733639651385759) (bởi [@Goodmanprotocol](https://x.com/Goodmanprotocol))
...
### Case 101: [Basketball Boy Motion Sequence](https://x.com/Taaruk_/status/2049702491768684839) (bởi [@Taaruk_](https://x.com/Taaruk_))
...
### Case 102: [Golden Hour Street Side-Profile Portrait](https://x.com/Professor_134/status/2049701241287311561) (bởi [@Professor_134](https://x.com/Professor_134))
...
### Case 106: [Cyberpunk Fashion Portrait](https://x.com/ChillaiKalan__/status/2050453739430195320) (bởi [@ChillaiKalan__](https://x.com/ChillaiKalan__))

| Đầu ra |
| :----: |
| <img src="./images/portrait_case106/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
### Case 107: [Japanese Negative Film Rooftop Portrait](https://x.com/BubbleBrain/status/2050449020645216532) (bởi [@BubbleBrain](https://x.com/BubbleBrain))

| Đầu ra |
| :----: |
| <img src="./images/portrait_case107/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
### Case 108: [Paris Café Lifestyle Portrait](https://x.com/Sairah_0/status/2050432730962530809) (bởi [@Sairah_0](https://x.com/Sairah_0))

| Đầu ra |
| :----: |
| <img src="./images/portrait_case108/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
### Case 109: [2x2 Editorial Portrait Grid](https://x.com/Taaruk_/status/2050429694890389779) (bởi [@Taaruk_](https://x.com/Taaruk_))

| Đầu ra |
| :----: |
| <img src="./images/portrait_case109/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
### Case 110: [Selective Color Sunglasses Portrait](https://x.com/aiistudiocom/status/2050745987443081437) (bởi [@aiistudiocom](https://x.com/aiistudiocom))
...
### Case 111: [Playful Doodle Photo Edit](https://x.com/Ciri_ai/status/2050625732448235817) (bởi [@Ciri_ai](https://x.com/Ciri_ai))
...
### Case 112: [Rainy Bus Window Portrait](https://x.com/john_my07/status/2050608887397789997) (bởi [@john_my07](https://x.com/john_my07))
...
> Xem tất cả các trường hợp → [cases/poster_vi.md](cases/poster_vi.md)
...
### Case 175: [Fitness Boxing Campaign Collage Poster](https://x.com/AIwithSynthia/status/2049718330353975652) (bởi [@AIwithSynthia](https://x.com/AIwithSynthia))
...
| Đầu ra |
| :----: |
| <img src="./images/poster_case177/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
| Đầu ra |
| :----: |
| <img src="./images/poster_case178/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
| Đầu ra |
| :----: |
| <img src="./images/poster_case179/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
| Đầu ra |
| :----: |
| <img src="./images/poster_case180/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
| Đầu ra |
| :----: |
| <img src="./images/poster_case181/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
| Đầu ra |
| :----: |
| <img src="./images/poster_case182/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
| Đầu ra |
| :----: |
| <img src="./images/poster_case183/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
### Case 184: [Fantasy Battle Storyboard Grid](https://x.com/GeorgeWuAI/status/2050749683430244830) (bởi [@GeorgeWuAI](https://x.com/GeorgeWuAI))
...
### Case 185: [Crayon Childhood Redraw](https://x.com/miratechtool/status/2050621516300026056) (bởi [@miratechtool](https://x.com/miratechtool))
...
## 🧍 Trường hợp Thiết kế Nhân vật

> Xem tất cả các trường hợp → [cases/character_vi.md](cases/character_vi.md)

<!-- Case 2: Persona5 Character Reference Card (by @iamrednightS) -->
### Case 2: [Persona5 Character Reference Card](https://x.com/iamrednightS/status/2045075682837836265) (bởi [@iamrednightS](https://x.com/iamrednightS))
...
### Case 7: [Mecha Girl Sea-City Key Visual](https://x.com/old_pgmrs_will/status/2046144801071079612) (bởi [@old_pgmrs_will](https://x.com/old_pgmrs_will))
...
### Case 11: [GTA 6 in Bangalore Flower Market](https://x.com/ismajc/status/2048174302164394493) (bởi [@ismajc](https://x.com/ismajc))
...
## 📱 Trường hợp Giao diện & Mô phỏng Mạng xã hội

> Xem tất cả các trường hợp → [cases/ui_vi.md](cases/ui_vi.md)

<!-- Case 104: One-Prompt UI Design Generation (by @austinit) -->
### Case 104: [One-Prompt UI Design Generation](https://x.com/austinit/status/2044968740782272596) (bởi [@austinit](https://x.com/austinit))
...
### Case 38: [Cyberpunk Neon UI Design System](https://x.com/AZLnfvp/status/2046468976092533180) (bởi [@AZLnfvp](https://x.com/AZLnfvp))
...
### Case 105: [Multi-Panel Image Board Template](https://x.com/aimikoda/status/2048183782876778821) (bởi [@aimikoda](https://x.com/aimikoda))
...
### Case 119: [Personal Color Analysis Graphic Board](https://x.com/ZaraIrahh/status/2049730770474877234) (bởi [@ZaraIrahh](https://x.com/ZaraIrahh))
...
### Case 120: [Futuristic Hall Fashion Shot Sequence](https://x.com/weiinberg/status/2049730563393884265) (bởi [@weiinberg](https://x.com/weiinberg))
...
### Case 161: [High-Fashion Beverage Campaign Board](https://x.com/SPEEDAI07/status/2049713995851202786) (bởi [@SPEEDAI07](https://x.com/SPEEDAI07))
...
### Case 121: [Hand-Drawn Storyboard Sheet](https://x.com/saniaspeaks_/status/2050465100973191219) (bởi [@saniaspeaks_](https://x.com/saniaspeaks_))

| Đầu ra |
| :----: |
| <img src="./images/ui_case121/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
### Case 122: [前后端数据库 SaaS 信息图](https://x.com/alantech_/status/2050462324486783060) (bởi [@alantech_](https://x.com/alantech_))

| Đầu ra |
| :----: |
| <img src="./images/ui_case122/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
### Case 123: [个人形象分析图卡](https://x.com/you1873118/status/2050446427105759269) (bởi [@you1873118](https://x.com/you1873118))

| Đầu ra |
| :----: |
| <img src="./images/ui_case123/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
### Case 124: [12-Panel Storyboard Poster](https://x.com/bmx_ai13/status/2050432594647642414) (bởi [@bmx_ai13](https://x.com/bmx_ai13))

| Đầu ra |
| :----: |
| <img src="./images/ui_case124/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
### Case 125: [人物时间轴信息图](https://x.com/crayon1267/status/2050743383560536427) (bởi [@crayon1267](https://x.com/crayon1267))
...
### Case 126: [GRWM 4x4 Party Grid](https://x.com/hosein2518/status/2050654683786523007) (bởi [@hosein2518](https://x.com/hosein2518))
...
### Case 127: [Xiaohongshu Doodle Photo Edit](https://x.com/ChillaiKalan__/status/2050614367536939243) (bởi [@ChillaiKalan__](https://x.com/ChillaiKalan__))
...
## 🧪 So sánh & Ví dụ Cộng đồng

> Xem tất cả các trường hợp → [cases/comparison_vi.md](cases/comparison_vi.md)

<!-- Case 35: Sam Altman Bear Selfie (by @JustinGorya) -->
### Case 35: [Sam Altman Bear Selfie](https://x.com/JustinGorya/status/2046510831832006970) (bởi [@JustinGorya](https://x.com/JustinGorya))
...
### Case 41: [Generate an image of the most significant event of 2020](https://x.com/Rufus87078959/status/2047211900769878234) (bởi [@Rufus87078959](https://x.com/Rufus87078959))
...
### Case 68: [Naturalist-Style Food Specimen Cross-Section](https://x.com/GeekCatX/status/2046939656244318676) (bởi [@GeekCatX](https://x.com/GeekCatX))
...
### Case 69: [视觉品牌拆解图](https://x.com/X7649158034321/status/2049721847001047274) (bởi [@X7649158034321](https://x.com/X7649158034321))
...
### Case 70: [Apartment Drama Animation Storyboard Sheet](https://x.com/CurieuxExplorer/status/2049709975040401601) (bởi [@CurieuxExplorer](https://x.com/CurieuxExplorer))
...
### Case 77: [Printable Paint by Numbers](https://x.com/TheRoaringToady/status/2050469389720314030) (bởi [@TheRoaringToady](https://x.com/TheRoaringToady))

| Đầu ra |
| :----: |
| <img src="./images/comparison_case77/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
### Case 78: [Modern Mafia Boss Portrait](https://x.com/john_my07/status/2050455807851147461) (bởi [@john_my07](https://x.com/john_my07))

| Đầu ra |
| :----: |
| <img src="./images/comparison_case78/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
### Case 80: [Cozy Scrapbook Mini Alter Egos](https://x.com/gold_force_guri/status/2050433982756721029) (bởi [@gold_force_guri](https://x.com/gold_force_guri))

| Đầu ra |
| :----: |
| <img src="./images/comparison_case79/output.jpg" width="300" alt="Hình ảnh đầu ra"> |
...
Kho lưu trữ này được lấy cảm hứng từ các bộ sưu tập gợi ý mở xuất sắc và các thử nghiệm GPT-Image-2 được chia sẻ bởi cộng đồng.

Cảm ơn các nhà sáng tạo và người đóng góp đã chia sẻ công việc của họ công khai và giúp các nghiên cứu trường hợp này trở thành hiện thực.
...
*Chúng tôi không thể đảm bảo rằng mọi trường hợp đều được ghi nhận đúng tác giả gốc. Nếu có điều gì cần chỉnh sửa, vui lòng liên hệ với chúng tôi và chúng tôi sẽ cập nhật.*

Nếu bạn có thêm các trường hợp gợi ý GPT-Image-2 thú vị để chia sẻ, hãy liên hệ và giúp chúng tôi mở rộng thư viện gợi ý Evolink.
