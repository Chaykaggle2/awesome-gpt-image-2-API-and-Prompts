...
<a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=banner&utm_campaign=awesome-gpt-image-2-API-and-Prompts"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/logo.png" alt="Logotipo del proyecto"></a>
...
Bienvenido al repositorio awesome-gpt-image-2-API-and-Prompts! 🤗
...
Pruebalo en Evolink: [GPT-Image-2](https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)
...
- [📰 Noticias](#noticias)
- [📑 Indice](#indice)
- [🛒 E-commerce Cases](cases/ecommerce_es.md)
- [📣 Ad Creative Cases](cases/ad-creative_es.md)
- [🍌 Portrait & Photography Cases](cases/portrait_es.md)
- [🎨 Poster & Illustration Cases](cases/poster_es.md)
- [🧍 Character Design Cases](cases/character_es.md)
- [📱 UI & Social Media Mockup Cases](cases/ui_es.md)
- [🧪 Comparison & Community Examples](cases/comparison_es.md)
- [🙏 Agradecimientos](#agradecimientos)

## 🛒 E-commerce Cases

> See all cases → [cases/ecommerce.md](cases/ecommerce_es.md)
...
> See all cases → [cases/ad-creative.md](cases/ad-creative_es.md)
...
> See all cases → [cases/portrait.md](cases/portrait_es.md)
...
> See all cases → [cases/poster.md](cases/poster_es.md)
...
> See all cases → [cases/character.md](cases/character_es.md)
...
> See all cases → [cases/ui.md](cases/ui_es.md)
...
> See all cases → [cases/comparison.md](cases/comparison_es.md)
