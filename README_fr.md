...
<a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=banner&utm_campaign=awesome-gpt-image-2-API-and-Prompts"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/logo.png" alt="Logo du projet"></a>
...
Bienvenue dans le depot awesome-gpt-image-2-API-and-Prompts ! 🤗
...
Essayez-le sur Evolink : [GPT-Image-2](https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)
...
- [📑 Sommaire](#sommaire)
- [🛒 E-commerce Cases](cases/ecommerce_fr.md)
- [📣 Ad Creative Cases](cases/ad-creative_fr.md)
- [🍌 Portrait & Photography Cases](cases/portrait_fr.md)
- [🎨 Poster & Illustration Cases](cases/poster_fr.md)
- [🧍 Character Design Cases](cases/character_fr.md)
- [📱 UI & Social Media Mockup Cases](cases/ui_fr.md)
- [🧪 Comparison & Community Examples](cases/comparison_fr.md)
- [🙏 Remerciements](#remerciements)

## 🛒 E-commerce Cases

> See all cases → [cases/ecommerce.md](cases/ecommerce_fr.md)
...
> See all cases → [cases/ad-creative.md](cases/ad-creative_fr.md)
...
> See all cases → [cases/portrait.md](cases/portrait_fr.md)
...
> See all cases → [cases/poster.md](cases/poster_fr.md)
...
> See all cases → [cases/character.md](cases/character_fr.md)
...
> See all cases → [cases/ui.md](cases/ui_fr.md)
...
> See all cases → [cases/comparison.md](cases/comparison_fr.md)
