...
<a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=banner&utm_campaign=awesome-gpt-image-2-API-and-Prompts"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/logo.png" alt="Logotipo do projeto"></a>
...
Bem-vindo ao repositorio awesome-gpt-image-2-API-and-Prompts! 🤗
...
Experimente no Evolink: [GPT-Image-2](https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)
...
- **30 de abril de 2026:** Foram adicionados 9 novos casos de prompts GPT-Image-2 do lote de busca das ultimas 24 horas (3 retrato, 1 poster, 3 UI, 2 comparacao) apos aprovacao e validacao de midia
...
- [📰 Novidades](#novidades)
- [📑 Indice](#indice)
- [🛒 E-commerce Cases](cases/ecommerce_pt.md)
- [📣 Ad Creative Cases](cases/ad-creative_pt.md)
- [🍌 Portrait & Photography Cases](cases/portrait_pt.md)
- [🎨 Poster & Illustration Cases](cases/poster_pt.md)
- [🧍 Character Design Cases](cases/character_pt.md)
- [📱 UI & Social Media Mockup Cases](cases/ui_pt.md)
- [🧪 Comparison & Community Examples](cases/comparison_pt.md)
- [🙏 Agradecimentos](#agradecimentos)

## 🛒 E-commerce Cases

> See all cases → [cases/ecommerce.md](cases/ecommerce_pt.md)
...
> See all cases → [cases/ad-creative.md](cases/ad-creative_pt.md)
...
> See all cases → [cases/portrait.md](cases/portrait_pt.md)
...
> See all cases → [cases/poster.md](cases/poster_pt.md)
...
> See all cases → [cases/character.md](cases/character_pt.md)
...
> See all cases → [cases/ui.md](cases/ui_pt.md)
...
> See all cases → [cases/comparison.md](cases/comparison_pt.md)
