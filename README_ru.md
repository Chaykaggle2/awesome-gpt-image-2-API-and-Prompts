...
Попробовать в Evolink: [GPT-Image-2](https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)
...
- [🛒 E-commerce Cases](cases/ecommerce_ru.md)
- [📣 Ad Creative Cases](cases/ad-creative_ru.md)
- [🍌 Portrait & Photography Cases](cases/portrait_ru.md)
- [🎨 Poster & Illustration Cases](cases/poster_ru.md)
- [🧍 Character Design Cases](cases/character_ru.md)
- [📱 UI & Social Media Mockup Cases](cases/ui_ru.md)
- [🧪 Comparison & Community Examples](cases/comparison_ru.md)
- [🙏 Благодарности](#благодарности)

## 🛒 E-commerce Cases

> See all cases → [cases/ecommerce.md](cases/ecommerce_ru.md)
...
> See all cases → [cases/ad-creative.md](cases/ad-creative_ru.md)
...
> See all cases → [cases/portrait.md](cases/portrait_ru.md)
...
> See all cases → [cases/poster.md](cases/poster_ru.md)
...
> See all cases → [cases/character.md](cases/character_ru.md)
...
> See all cases → [cases/ui.md](cases/ui_ru.md)
...
> See all cases → [cases/comparison.md](cases/comparison_ru.md)
